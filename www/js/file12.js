...
var Twitter = {
								...
								oauth
										.get(
												...
												function(data) {
													...
													$("#welcome").show();
													document
															.getElementById("welcome").innerHTML = "welcome "
															+ entry.screen_name;
													successfulLogin();
													// Just for eg.
													app.init();
	...
	tweet : function() {
		...
		options.accessTokenKey = storedAccessData.accessTokenKey; // it will
																	// be saved
																	// on first
																	// signin
		options.accessTokenSecret = storedAccessData.accessTokenSecret; // it
																		// will
																		// be
																		// save
																		// on
		...
		// javascript OAuth will care of else for app we need to send only the
		// options
		oauth = OAuth(options);
		oauth
				.get(
	 ...
	 */
	post : function() {
		var theTweet = $("#tweet").val(); // You can change it with what else
											// you likes.
