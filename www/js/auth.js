    ...
    if (session.authResponse) {
        ...
        function(response) {
          if (!response.error) {
            ...
            if (document.getElementById('fbpic')) {
                document.getElementById('fbpic').src = "https://graph.facebook.com/"+user.id+"/picture?width=300&height=300";
              }
            if (document.getElementById('user-picture')) {
              document.getElementById('user-picture').innerHTML = user.picture.data.url;
